...
<style>
  aside {
    width: 200px;
    height: 600px;         /* lock — prevents flex stretch on content change */
    background: #060A06;
  ...
  .panel-title {
    ...
    background: linear-gradient(180deg, #0D160D, #080D08);
  ...
  .section-label { color:#3A7A3A; font-size:8px; letter-spacing:2px; text-transform:uppercase; margin-bottom:5px; text-shadow: 0 0 6px rgba(0,180,60,0.4); }
  /* Build grid */
